...
<body>
	<img src="visual.png" style="position: absolute; left: 250px; top: 0px">
	<div style="position: relative; left: 16px">
		...
		<div id="heading" style="padding-top: 28px">
			<div>
				Link your <img src="gplus.png" alt="Google+" style="vertical-align: -20px"> and <img
					src="picasa.png" alt="Picasa" style="vertical-align: -10px">
			</div>
			<div>
